<template>
  ...
  >
    ...
    >
      ...
      <div class="tutorial d-flex flex-column align-center justify-center">
        <img
          src="@/assets/images/current_location.png"
          alt="Send"
        >
        <h3 class="fs--19 fw--700">
          Setup Tutorial
        </h3>
        <p class="fs--13 fw--500 text-center">
          Lorem ipsum sit amet,
          consectetur adiscing elit
        </p>
      </div>

      <div class="social ps-5 mt-4">
        <img
    ...
    <div class="side-nav-content pt-10">
      <v-list
        expand
        shaped
        class="vertical-nav-menu-items pt-15"
      >
        <component
          :is="resolveNavItemComponent(item)"
          v-for="item in navMenuItems"
